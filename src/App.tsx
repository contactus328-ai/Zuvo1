...
export default function App() {
  ...
  const [isProfileComplete, setIsProfileComplete] = useState<boolean>(false);
      // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard: which screens require a signed-in user ----
  ...
  }, [isAuthenticated, currentScreen]);   // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard:   // ---- Auth guard: which screens require a signed-in user ----
  const PROTECTED_SCREENS: Screen[] = [
    'home','event_detail','register','results',
    'org_dashboard','add_event','my_org','participants',
    'my_part','profile','liveStream'
